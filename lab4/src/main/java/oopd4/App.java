...
//public class App {
    ...
    // problem-6(p-1): Write a program to sort an array using bubble sort, selection sort, and merge sort.

    // Bubble Sort
    // int[] bubbleSortArray = {5, 2, 8, 12, 1};

    // System.out.println("Array before bubble sort: " + Arrays.toString(bubbleSortArray));
    // System.out.println("");
    ...
    // System.out.println("Array after bubble sort: " + Arrays.toString(bubbleSortArray));
    // System.out.println("");

    // // Selection Sort
    // int[] selectionSortArray = {5, 2, 8, 12, 1};

    // System.out.println("Array before selection sort: " + Arrays.toString(selectionSortArray));
    // System.out.println("");
    ...
    // System.out.println("Array after selection sort: " + Arrays.toString(selectionSortArray));

    // problem-7(p-2): Write a program to multiply two matrices.
